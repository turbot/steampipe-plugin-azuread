...
func tableAzureAdAuthorizationPolicy(_ context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "allow_invites_from", Type: proto.ColumnType_STRING, Description: "Indicates who can invite external users to the organization. Possible values are: none, adminsAndGuestInviters, adminsGuestInvitersAndAllMembers, everyone.", Transform: transform.FromMethod("GetAllowInvitesFrom")},
