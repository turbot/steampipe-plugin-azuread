...
func tableAzureAdDirectoryRoleTest() *plugin.Table {
	return &plugin.Table{
		...
		List: &plugin.ListConfig{
			Hydrate: listAdDirectoryRolesTest,
		},
...
func listAdDirectoryRolesTest(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	// Create client
...
func getAdDirectoryRoleTest(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
