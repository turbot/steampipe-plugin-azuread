...
func tableAzureAdConditionalAccessPolicy(_ context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: commonColumns([]*plugin.Column{
			...
			{Name: "service_principal_risk_levels", Type: proto.ColumnType_JSON, Description: "Service principal risk levels included in the policy. Possible values are: low, medium, high, hidden, none, unknownFutureValue.", Transform: transform.FromMethod("ConditionalAccessPolicyConditionsServicePrincipalRiskLevels")},
