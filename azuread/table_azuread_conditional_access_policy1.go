...
func tableAzureAdConditionalAccessPolicyTest() *plugin.Table {
	return &plugin.Table{
		Name:        "azuread_conditional_access_policy_test",
		Description: "Represents an Azure Active Directory (Azure AD) Conditional Access Policy",
		Get: &plugin.GetConfig{
			Hydrate: getAdConditionalAccessPolicyTest,
		...
		List: &plugin.ListConfig{
			Hydrate: listAdConditionalAccessPoliciesTest,
			IgnoreConfig: &plugin.IgnoreConfig{
...
func listAdConditionalAccessPoliciesTest(ctx context.Context, d *plugin.QueryData, _ *plugin.HydrateData) (interface{}, error) {
	// Create client
...
func getAdConditionalAccessPolicyTest(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
