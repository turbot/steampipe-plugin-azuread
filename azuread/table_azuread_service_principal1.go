...
func tableAzureAdServicePrincipalTest() *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			{Name: "published_permission_scopes", Type: proto.ColumnType_JSON, Description: "The published permission scopes.", Transform: transform.FromMethod("ServicePrincipalOauth2PermissionScopes")},
