...
- Recompiled plugin with Go version `1.22`. ([#198](https://github.com/turbot/steampipe-plugin-azuread/pull/198))
- Recompiled plugin with [steampipe-plugin-sdk v5.10.4](https://github.com/turbot/steampipe-plugin-sdk/blob/develop/CHANGELOG.md#v5104-2024-08-29) that fixes logging in the plugin export tool. ([#198](https://github.com/turbot/steampipe-plugin-azuread/pull/198))
