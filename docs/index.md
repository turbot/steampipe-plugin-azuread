...
| Permissions | Grant the following permissions to your user: <br /><li> `Application.Read.All` </li><li> `Policy.Read.ConditionalAccess` </li><li> `Directory.Read.All` </li><li> `Domain.Read.All` </li><li> `Group.Read.All` </li><li> `IdentityProvider.Read.All` </li><li> `User.Read.All`                                                                                                                                                              |
